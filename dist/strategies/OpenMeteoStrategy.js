...
class OpenMeteoStrategy extends BaseStrategy_1.BaseStrategy {
    ...
    excludedCities = ['london', 'seoul', 'beijing', 'shanghai', 'shenzhen'];
    async execute(markets) {
        ...
        for (const market of markets) {
            ...
            if (forecastCache[cacheKey] === undefined) {
                ...
                forecastCache[cacheKey] = await OpenMeteoService_1.OpenMeteoService.getForecastedHighs(matchedCity, isCelsius);
            }
...
exports.OpenMeteoStrategy = OpenMeteoStrategy;
